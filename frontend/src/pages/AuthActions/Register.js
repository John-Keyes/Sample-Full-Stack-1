...
import {ClearFeedback, UpdateFeedback} from '../../Redux/reducer';
    ...
    return (
        <div className="formContainer">
            <CustomTextInput 
                ...
                Condition={val => dispatch(UpdateFeedback("firstName", val))}
            />
            <CustomTextInput 
                borderType={'u'} 
                ...
                Condition={val => dispatch(UpdateFeedback("lastName", val))}
            />
            <CustomTextInput 
                borderType={'u'} 
                inputType={"email"}
                ...
                value={email} 
                setValue={setEmail}
                Condition={val => dispatch(UpdateFeedback("email", val))}
            />
            <CustomTextInput 
                borderType={'u'} 
                ...
                Condition={val => dispatch(UpdateFeedback("password", val))}
                right={() => 
            ...
            />
            <Button additionalClassNames={"signButton"} toggle={() => SubmitRegistration()}>
